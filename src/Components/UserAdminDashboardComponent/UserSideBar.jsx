    ...
    return (
        <>
            <div className="hidden md:flex absolute  w-20 group hover:w-70 group :hover p-3 h-dvh border-r-1 border-black-100 bg-white shadow-2xl overflow-hidden flex-wrap scroll-auto">
                ...
                {/* user logo */}
                <ul className="flex mt-5 flex-col w-full h-full  overflow-y-auto scrollbar-hidden" >
                    ...
                    <li><a className="dashboardsideIcon " href=""><i className="fa-solid fa-list"></i>Items List</a></li>
                    <li><a className="dashboardsideIcon " href=""><i className="fa-regular fa-pen-to-square"></i>Add Items</a></li>
                    <li><a className="dashboardsideIcon " href=""><i className="fa-solid fa-magnifying-glass"></i>Search Items</a></li>
                </ul>
