                ...
                <div className="flex flex-col my-4 mx-4 w-full">
                    ...
                    <div className="mt-4 flex flex-wrap w-full justify-around ">
                        <div className="cursor-pointer h-25 w-35 md:h-30 md:w-50 group m-4  bg-amber-100 hover:bg-amber-200 hover:shadow-xl text-black-400 hover:text-black-600 rounded-xl flex flex-col p-4 ">
                            <p className="flex justify-between items-center">Total Students<i class="fa-solid fa-receipt text-lg"></i> </p>
                            <p className=" group-hover:text-amber-700 w-full flex justify-center text-2xl font-bold">4324</p>
                        </div>
                         <div className="cursor-pointer h-25 w-35 md:h-30 md:w-50 group m-4  bg-amber-100 hover:bg-amber-200 hover:shadow-xl text-black-400 hover:text-black-600 rounded-xl flex flex-col p-4 ">
                            <p className="flex justify-between items-center">Totoal CoAdmin<i class="fa-solid fa-receipt text-lg"></i> </p>
                            <p className=" group-hover:text-amber-700 w-full flex justify-center text-2xl font-bold">4324</p>
                        </div>
                         <div className="cursor-pointer h-25 w-35 md:h-30 md:w-50 group m-4  bg-amber-100 hover:bg-amber-200 hover:shadow-xl text-black-400 hover:text-black-600 rounded-xl flex flex-col p-4 ">
                            <p className="flex justify-between items-center">Total Products<i class="fa-solid fa-receipt text-lg"></i> </p>
                            <p className=" group-hover:text-amber-700 w-full flex justify-center text-2xl font-bold">4324</p>
                        </div>
                         <div className="cursor-pointer h-25 w-35 md:h-30 md:w-50 group m-4  bg-amber-100 hover:bg-amber-200 hover:shadow-xl text-black-400 hover:text-black-600 rounded-xl flex flex-col p-4 ">
                          ...
                          <div className="cursor-pointer h-25 w-35 md:h-30 md:w-50 group m-4  bg-amber-100 hover:bg-amber-200 hover:shadow-xl text-black-400 hover:text-black-600 rounded-xl flex flex-col p-4 ">
                            <p className="flex justify-between items-center">approved Products<i class="fa-solid fa-receipt text-lg"></i> </p>
                            <p className=" group-hover:text-amber-700 w-full flex justify-center text-2xl font-bold">4324</p>
                        </div>
                           <div className="cursor-pointer h-25 w-35 md:h-30 md:w-50 group m-4  bg-amber-100 hover:bg-amber-200 hover:shadow-xl text-black-400 hover:text-black-600 rounded-xl flex flex-col p-4 ">
                            <p className="flex justify-between items-center">Rejected Products<i class="fa-solid fa-receipt text-lg"></i> </p>
                            <p className=" group-hover:text-amber-700 w-full flex justify-center text-2xl font-bold">4324</p>
                        </div>
                    </div>
                    <br></br>
