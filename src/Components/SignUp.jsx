...
export default function SignUp() {
  ...
  // Rotate person image
  // should uncommit after development
  useEffect(() => {
    let img_num = 0;
  ...
  const handleSubmit = async (e) => {
    setShowMsg(false);
    setLoading(true);    // reset show msg
    ...
    if (email && password && confirmPassword && emailValid && passwordValid && passwordsMatch) {
      ...
      setShowMsg(false);         // hide previous messages

      // Simulate API call (replace with your API)
       await API.post("/user/register", { email, password, confirmPassword });
      // On success
      setLoading(false);         // stop loading
      setShowMsg(true);
      setMsgType("success");
      setMsg("Account created successfully. Sign in now");
  ...
  return (
    <>
      ...
      <div className="  lg:relative lg:top-0">
        <div className="flex relative z-1 h-full w-[80%] mx-auto justify-center items-center flex-col md:flex-row">
          ...
          {/* Sign up form */}
          <div className="relative my-5 w-full md:w-100 overflow-hidden p-5 rounded-3xl  flex flex-col justify-center items-center">
            <img
            ...
            <div className="mt-5 w-full flex flex-col items-center">
              ...
              >
                ...
                <input
                  ...
                  placeholder="Email"
                  className={`input-form-text ${(!emailValid || (formSubmitted && !email))
                    ? "border-red-700"
                    : "border-black-400"
                    }`}
                />
                ...
                <input
                  ...
                  className={`input-form-text ${(!passwordValid || (formSubmitted && !password))
                    ? "border-red-500"
                    : "border-black-400"
                    }`}
                />
                ...
                <input
                  ...
                  className={`input-form-text ${(!passwordsMatch || (formSubmitted && !confirmPassword))
                    ? "border-red-500"
                    : "border-black-400"
                    }`}
                />
                ...
                <button
                  type="submit"
                  value="Login"
                  className=" md:w-1/3 flex justify-center button-goldenflare-lite"
                >
                  Sign Up
                </button>
              </form>
              ...
              <div className="w-full mt-3 flex flex-col items-center">
                <p>
                  ...
                  <Link to="/signIn" className="text-red-700 cursor-pointer underline">Sign In</Link>{" "}
                  now
                </p>
              </div>
            </div>
